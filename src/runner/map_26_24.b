SECTIONS["26,24"] := {
    ...
    "start": this => {
        eraseShape(5293, 4986, 1);
        if(player.gameState["switch_5374_5041_1"] = true) {
            setShape(5293, 4986, 1, "teleport.x");
        }
    },
    "teleport": (this, x, y, z) => {
        if(x >= 5396 && x < 5400 && y >= 4908 && y < 4912 && z = 1) {
            ...
            return [ 5397, 4914, 1 ];
        } else if(player.gameState["switch_5374_5041_1"] = true && x = 5293 && y >= 4986 && y < 4990 && z = 1) {
            return [ 5510, 5067, 1 ];
        }
        return null;
    },
